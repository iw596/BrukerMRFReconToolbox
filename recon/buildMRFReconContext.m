...
context.AdaptiveRho = logical(getfield_default(settings, 'AdaptiveRho', false));
context.RhoMu = getfield_default(settings, 'RhoMu', 10);
context.RhoTau = getfield_default(settings, 'RhoTau', 2);
context.RhoMin = getfield_default(settings, 'RhoMin', context.Rho / 1e3);
context.RhoMax = getfield_default(settings, 'RhoMax', context.Rho * 1e3);
