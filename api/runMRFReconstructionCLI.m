...
if (options.MRFReconMode == "direct")
    results = runDirectMRFReconstruction(data);
else
    results = runSubSpaceMRFReconstruction(data);
end



%% After reconstruction we our set of MRF images. Now we perform dictionary matching
