...
rawdata = reshape(rawdata, [params.NCol params.NMRFFA * params.MRFNPrepModules params.NLin]);
...
figure(13);plot(squeeze(angle(imgs(99,25,:)))); hold on; plot(angle((normalisedDict(:,end-10))));
