...
gridSize = [128, 128];
targetPoints = 8192;
initialRadius = 4; % Starting radius
centralBiasFactor = 5; % Central bias strength

% Generate Sampling Mask
[samplingMask, sampledPointsCount] = optimizedPoissonDiskSampling(gridSize, targetPoints, initialRadius, centralBiasFactor);

% Visualize the mask
figure;
imagesc(samplingMask); axis image; colormap('gray');
title('Optimized Poisson Disk Sampling Mask');
