...
%% Load reference AFI
params = LoadBrukerData("C:\Users\kpqv532\OneDrive - University of Leeds\20250529_085103_MRF_Phantom_MRFDev_29052025_1_29\48");
data = params.data;
...
imgs = abs(ifftcn(data,[1 2 3]));
AFIB1Map_ref = FitAFIB1(imgs,60,30e-3,150e-3);


%% Load EPIC AFI
params = LoadBrukerData("C:\Users\kpqv532\OneDrive - University of Leeds\20250602_110808_MRF_Phantom_MRF_Dev_02062025_1_30\12");
data = params.data;
...
params = LoadBrukerData("C:\Users\kpqv532\OneDrive - University of Leeds\20250602_110808_MRF_Phantom_MRF_Dev_02062025_1_30\9");
data = params.data;
...
% FFT into imgs for each channel
imgs_45 = abs(ifftcn(data,[1 2 3]));

params = LoadBrukerData("C:\Users\kpqv532\OneDrive - University of Leeds\20250602_110808_MRF_Phantom_MRF_Dev_02062025_1_30\11");
data = params.data;
...
% Permute into Read-Lines-Par-Cha-Rep
% FFT into imgs for each channel
imgs_90 = abs(ifftcn(data,[1 2 3]));

DAMB1 = acosd(imgs_90./(2.*imgs_45))./45;

figure; imagesc(abs(DAMB1(:,:,24)),[0.5 1.2]); colormap("turbo")
figure; imagesc(abs(AFIB1Map_epic(:,:,24)),[0.5 1.2]); colormap("turbo")