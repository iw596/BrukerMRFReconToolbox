...
params = LoadBrukerData("C:\Users\kpqv532\OneDrive - University of Leeds\20250603_154005_PhosphoricAcid_b1mapping_1_2\6");
data = params.data;
...
pth = "C:\Users\kpqv532\OneDrive - University of Leeds\20250603_154005_PhosphoricAcid_b1mapping_1_2\";
...
% Do a profile plot
AFI_tmpImg = abs(squeeze(AFIB1MapFiltered_masked(24,:,:)));
AFI_profile = squeeze(AFI_tmpImg(idx,:));
DAM_tmpImg = abs(squeeze(DAMB1MapFiltered_masked(24,:,:)));
...
figure(13)
subplot(1,2,1);imagesc(abs(squeeze(DAMB1(24,:,:))),[0.5 1.2]); colormap("turbo"); colorbar;title("Double Angle Method");
subplot(1,2,2); imagesc(abs(squeeze(AFIB1Map(24,:,:))),[0.5 1.2]); colormap("turbo");colorbar;title("AFI")
