...
% Parameters for Hybrid Poisson Disk Sampling
gridSize = [128, 128];
centralRadius = 2; % Smaller radius for central region
peripheralRadius = 5; % Larger radius for peripheral region
centralFactor = 0.3; % Central region size factor (e.g., 30% of grid)
peripheralFactor = 0.7; % Peripheral region size factor
biasFactor = 1; % Central weighting bias

% Call the function
% Generate Sampling Mask
samplingMask = poissonDiskCentralHybrid(gridSize, centralRadius, peripheralRadius, centralFactor, peripheralFactor, biasFactor);
